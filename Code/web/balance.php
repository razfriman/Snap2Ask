...
?>
		<form name="addtutorfunds" id="addtutorfunds" action="#" method=<?php
...
?>
    ...
    <h2><br/>COMING SOON:</h2> <p>Tutor's withdrawal and deposit history will be shown here in table format.</p>
	</section>
